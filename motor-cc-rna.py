...
motorccRNA.add(Dense(28, activation='relu'))
motorccRNA.add(Dense(12, activation='relu'))
motorccRNA.add(Dense(8, activation='relu'))
...
#Treinar
motorccRNA.fit(X_train, y_train, epochs=25, batch_size=32, validation_data=(X_test, y_test))
#%%
